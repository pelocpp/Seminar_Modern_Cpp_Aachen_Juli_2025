...
namespace Lambdas {
    ...
    static void test_03(bool flagDirection)
    {
        ...
        public:
            ...
            bool operator() (int n1, int n2) const {
                std::cout << "local operator() vgl. " << n1 << " mit " << n2 << std::endl;
   ...
   //     bool flagDirection = true;
        ...
        auto myLambdaVoid = [=](int n1, int n2) -> void {
            auto sum = n1 + n2;
        };
        ...
        std::function<bool(int, int)> myLamda2 = [=](int n1, int n2) {
            std::cout << "std::function vgl. " << n1 << " mit " << n2 << std::endl;
    ...
    static void test_incrementer() {

        auto wert = 10;

        auto incrementer = [wert = 10] mutable {
